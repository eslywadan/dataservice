...
'''     
        ...
        self._sql_get_spc_data = sql_get_spc_data + " and oos_ind<>'Y' and substr(spc_chart_type_cd,1,2) in ('AG','XX')"
    ...
    def wrangle_edc_data(self,drop_all_na=True):
    ...
    def infer_edc_col_type(df:pd.DataFrame,rowkey=None):
        ...
        """
        return PdExt.coltype(df,rowkey)
